...
abstract class BaseDimCommentsPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('CommentId', 'Comment', 'Title', 'Link', 'Spread', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('commentId', 'comment', 'title', 'link', 'spread', ),
        BasePeer::TYPE_COLNAME => array (DimCommentsPeer::COMMENT_ID, DimCommentsPeer::COMMENT, DimCommentsPeer::TITLE, DimCommentsPeer::LINK, DimCommentsPeer::SPREAD, ),
        BasePeer::TYPE_RAW_COLNAME => array ('COMMENT_ID', 'COMMENT', 'TITLE', 'LINK', 'SPREAD', ),
        BasePeer::TYPE_FIELDNAME => array ('comment_id', 'comment', 'title', 'link', 'spread', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('CommentId' => 0, 'Comment' => 1, 'Title' => 2, 'Link' => 3, 'Spread' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('commentId' => 0, 'comment' => 1, 'title' => 2, 'link' => 3, 'spread' => 4, ),
        BasePeer::TYPE_COLNAME => array (DimCommentsPeer::COMMENT_ID => 0, DimCommentsPeer::COMMENT => 1, DimCommentsPeer::TITLE => 2, DimCommentsPeer::LINK => 3, DimCommentsPeer::SPREAD => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('COMMENT_ID' => 0, 'COMMENT' => 1, 'TITLE' => 2, 'LINK' => 3, 'SPREAD' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('comment_id' => 0, 'comment' => 1, 'title' => 2, 'link' => 3, 'spread' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
