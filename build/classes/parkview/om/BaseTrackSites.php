 ...
 */
abstract class BaseTrackSites extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TrackSitesPeer';
    ...
    public function setPlace($v)
    {
        ...
        if ($this->place !== $v) {
            $this->place = $v;
            $this->modifiedColumns[] = TrackSitesPeer::PLACE;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TrackSitesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TrackSitesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TrackSitesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    {
        $pos = TrackSitesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TrackSites'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of TrackSites (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TrackSites Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TrackSitesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TrackSitesPeer();
        }
     ...
     * If this TrackSites is new, it will return
    ...
    public function setFactSnsdatas(PropelCollection $factSnsdatas, PropelPDO $con = null)
    {
        ...
        foreach ($factSnsdatasToDelete as $factSnsdataRemoved) {
            $factSnsdataRemoved->setTrackSites(null);
        }
    ...
    protected function doAddFactSnsdata($factSnsdata)
    {
        ...
        $factSnsdata->setTrackSites($this);
    }
    ...
    public function removeFactSnsdata($factSnsdata)
    {
        if ($this->getFactSnsdatas()->contains($factSnsdata)) {
            ...
            $factSnsdata->setTrackSites(null);
        }
     ...
     * Otherwise if this TrackSites is new, it will return
     * an empty collection; or if this TrackSites has previously
     * been saved, it will retrieve related FactSnsdatas from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TrackSites.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(TrackSitesPeer::DEFAULT_STRING_FORMAT);
    }
