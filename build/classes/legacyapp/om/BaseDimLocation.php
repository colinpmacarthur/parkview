...
/**
 * Base class that represents a row from the 'dim_location' table.
 *
 *
 *
 * @package    propel.generator.legacyapp.om
 */
abstract class BaseDimLocation extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DimLocationPeer';
     ...
     * @return DimLocation The current object (for fluent API support)
     */
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = DimLocationPeer::CITY;
        }
    ...
    public function setState($v)
    {
        ...
        if ($this->state !== $v) {
            $this->state = $v;
            $this->modifiedColumns[] = DimLocationPeer::STATE;
        }
    ...
    public function setRecid($v)
    {
        ...
        if ($this->recid !== $v) {
            $this->recid = $v;
            $this->modifiedColumns[] = DimLocationPeer::RECID;
        }
    ...
    public function setLocationid($v)
    {
        ...
        if ($this->locationid !== $v) {
            $this->locationid = $v;
            $this->modifiedColumns[] = DimLocationPeer::LOCATIONID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->city = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->state = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->recid = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->locationid = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = DimLocationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating DimLocation object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DimLocationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DimLocationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DimLocationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DimLocationPeer::CITY)) {
            $modifiedColumns[':p' . $index++]  = '`city`';
        }
        if ($this->isColumnModified(DimLocationPeer::STATE)) {
            $modifiedColumns[':p' . $index++]  = '`state`';
        }
        if ($this->isColumnModified(DimLocationPeer::RECID)) {
            $modifiedColumns[':p' . $index++]  = '`recid`';
        }
        if ($this->isColumnModified(DimLocationPeer::LOCATIONID)) {
            $modifiedColumns[':p' . $index++]  = '`locationID`';
        }

        $sql = sprintf(
            'INSERT INTO `dim_location` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DimLocationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DimLocationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DimLocation'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DimLocation'][$this->getPrimaryKey()] = true;
        $keys = DimLocationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCity(),
            $keys[1] => $this->getState(),
            $keys[2] => $this->getRecid(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setCity($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setState($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setRecid($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DimLocationPeer::CITY)) $criteria->add(DimLocationPeer::CITY, $this->city);
        if ($this->isColumnModified(DimLocationPeer::STATE)) $criteria->add(DimLocationPeer::STATE, $this->state);
        if ($this->isColumnModified(DimLocationPeer::RECID)) $criteria->add(DimLocationPeer::RECID, $this->recid);
        if ($this->isColumnModified(DimLocationPeer::LOCATIONID)) $criteria->add(DimLocationPeer::LOCATIONID, $this->locationid);
    ...
    {
        $criteria = new Criteria(DimLocationPeer::DATABASE_NAME);
        $criteria->add(DimLocationPeer::LOCATIONID, $this->locationid);
     ...
     * objects.
     *
     * @param object $copyObj An object of DimLocation (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return DimLocation Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DimLocationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DimLocationPeer();
        }
     ...
     * If this DimLocation is new, it will return
    ...
    public function setFtSocialdatas(PropelCollection $ftSocialdatas, PropelPDO $con = null)
    {
        ...
        foreach ($ftSocialdatasToDelete as $ftSocialdataRemoved) {
            $ftSocialdataRemoved->setDimLocation(null);
        }
    ...
    protected function doAddFtSocialdata($ftSocialdata)
    {
        ...
        $ftSocialdata->setDimLocation($this);
    }
    ...
    public function removeFtSocialdata($ftSocialdata)
    {
        if ($this->getFtSocialdatas()->contains($ftSocialdata)) {
            ...
            $ftSocialdata->setDimLocation(null);
        }
     ...
     * Otherwise if this DimLocation is new, it will return
     * an empty collection; or if this DimLocation has previously
     * been saved, it will retrieve related FtSocialdatas from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in DimLocation.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(DimLocationPeer::DEFAULT_STRING_FORMAT);
    }
